      ...
      <div className="about-me__container">
        ...
        <div className="about-me__main">
          <div className="about-me__textblock">
            ...
            Я родился и живу в Тюмени, закончил ТюмГНГУ. Женат. Есть дочь. 
            Люблю путешествовать(есть большая мечта посетить Северную Америку), прогулки пешком и на велосипеде. С 2007 года работаю в гостиничном бизнесе. 
             Недавно начал кодить. Прохожу курс по веб-разработке, ищу работу фронтенд-разработчиком.
            </p>
            <div className="about-me__links">
            <a href="https://github.com/PavelKuzmichev/" className="about-me__link" target="_blank">Github</a>
          <a href="https://t.me/PaulPhink" className="about-me__link" target="_blank">Telegram</a>
