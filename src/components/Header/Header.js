...
function Header() {
                ...
                { loggedIn ?
                    (
                        <>
                            ...
                            <Navigation />
                            <Link to='/profile' title='Аккаунт' className='header__link header__link_account'>
                    ...
                    (
                        <div className='header__sign '>
                            ...
                            <Link to='/signin' title='Войти' className='header__link header__link_enter'>Войти</Link>
                        </div>
                    )
                }
    ...
    } return (<><div className={` ${isOpen ? 'header__menu-container' : ''}`} />
